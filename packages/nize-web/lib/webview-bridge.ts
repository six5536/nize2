...
// executes against the live DOM, and returns results.
...
/**
 * Initialize the webview bridge. Safe to call multiple times; only the
 * first call sets up console interception and WebSocket connection.
 */

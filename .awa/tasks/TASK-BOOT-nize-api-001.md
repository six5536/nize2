...
TEST CRITERIA: `npx tsp compile .awa/specs/API-NIZE-index.tsp` produces openapi.yaml

- [x] T-BOOT-020 Create common TypeSpec file — service def, ErrorResponse model → .awa/specs/API-NIZE-common.tsp
- [x] T-BOOT-021 Create index TypeSpec file — HelloWorldResponse model, GET /api/hello → .awa/specs/API-NIZE-index.tsp

...
- `lib/auth-context.tsx` already adapted for nize-mcp (zen markers, slight differences — keep nize-mcp version)
...
2. **`lib/auth-context.tsx` — KEEP nize-mcp version.** Already adapted; functionally equivalent to ref but with nize-mcp zen markers and minor wording tweaks.
